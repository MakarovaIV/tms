...
urlpatterns = [
    ...
    path('projects/<int:proj_id>/suit/delete/<int:pk>/', views.SuitDeleteView.as_view(), name='suit_del'),
    ...
    path('projects/<int:proj_id>/suit/<int:suit_id>/tc/delete/<int:pk>', views.TestCaseDelete.as_view(), name="tc_delete"),
